...
public class CrudConfiguration implements CrudConstants {
    ...
    public void scan(Package... packages) throws InstantiationException, IllegalAccessException {
        ...
        scanner.addIncludeFilter(new AnnotationTypeFilter(applica.framework.annotations.Grid.class));
        scanner.addIncludeFilter(new AnnotationTypeFilter(applica.framework.annotations.Form.class));
    ...
    private void scanForForm(Class<?> type) {
        applica.framework.annotations.Form formAnnotation = type.getAnnotation(applica.framework.annotations.Form.class);
    ...
    private void scanForGrid(Class<?> type) {
        applica.framework.annotations.Grid gridAnnotation = type.getAnnotation(applica.framework.annotations.Grid.class);
